-- LaTeX treesitter test runner for nabla.nvim
local fail = false
...
package.loaded['nabla.latex_ts'] = dofile(path .. '/lua/nabla/latex_ts.lua')
...
for _, file in ipairs(files) do
  ...
  local ok, result = pcall(nabla.gen_drawing_latex_ts, expr)
...
if not fail then
  print("ALL LATEX_TS TESTS PASSED")
end
