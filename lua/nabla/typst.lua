...
local ident_map = {
  ...
  infinity = "infty", nothing = "emptyset",
  diff = "partial", partial = "partial", nabla = "nabla", gradient = "nabla",
  compose = "circ", div = "div", times = "times",
  approx = "approx", equiv = "equiv", prec = "prec", succ = "succ",
  sim = "sim", simeq = "simeq", doteq = "doteq",
  pm = "pm", mp = "mp", cdot = "cdot",
  dots = "dots", cdots = "cdots", vdots = "vdots", ddots = "ddots", ldots = "ldots",

  frac = "frac", sqrt = "sqrt", root = "root",

  hat = "hat", tilde = "tilde", dot = "dot", ddot = "ddot", dddot = "dddot",
  arrow = "vec", macron = "overline", overline = "overline",
  dash = "dash", grave = "grave", acute = "acute", breve = "breve",
  circle = "circle", caron = "caron",

  bold = "boldsymbol", bb = "mathbb", cal = "mathcal", frak = "mathfrak",
  italic = "mathit", mono = "mathtt", upright = "upright", sans = "sans", scr = "scr",
  ...
  cancel = "cancel", ul = "ul", strike = "strike",
  overbrace = "overbrace", underbrace = "underbrace",
  overbracket = "overbracket", underbracket = "underbracket",
  overparen = "overparen", underparen = "underparen",
  overshell = "overshell", undershell = "undershell",
  mid = "mid",
  ...
  dim = "dim", ker = "ker", hom = "hom", deg = "deg",
...
local consumes_args = {
  sqrt = 1,
  hat = 1, tilde = 1, dot = 1, ddot = 1, dddot = 1,
  circle = 1, caron = 1,
  vec = 1, overline = 1, dash = 1, grave = 1, acute = 1, breve = 1,
  boldsymbol = 1, mathbb = 1, mathcal = 1, mathfrak = 1, mathit = 1, mathtt = 1,
  cancel = 1, ul = 1, strike = 1,
  overbrace = 1, underbrace = 1,
  overbracket = 1, underbracket = 1,
  overparen = 1, underparen = 1,
  overshell = 1, undershell = 1,
  bar = 1, Vert = 1,
  floor = 1, ceil = 1, round = 1,
  upright = 1, sans = 1, scr = 1,
}
...
function M.walk_prime(node, buf)
  ...
  for child in node:iter_children() do
    ...
    elseif get_text(child, buf) == "'" then
